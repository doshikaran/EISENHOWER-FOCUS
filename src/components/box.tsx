  ...
  return (
    <div className="border p-10 rounded-lg">
      <div className="flex gap-3">
        <div className="w-8/12 flex-col border-[#344e41]">
          <div className="flex items-center  border-[#344e41]">
            <div className="w-12 whitespace-nowrap	 p-4"></div>
            <div className="w-2/4 p-3 text-[#344e41] text-lg font-bold border-l border-[#344e41]">
              Urgent
            </div>
            <div className="w-2/4 p-3 text-[#344e41] text-lg font-bold border-l border-[#344e41]">
              Not Urgent
          ...
          <div className="flex min-h-40">
            <div className="w-12 whitespace-nowrap flex justify-center items-center p-4 border-t border-[#344e41]">
              <span className="rotate-[270deg] text-[#344e41] inline-block text-lg font-bold">
                Important
              </span>
            </div>
            <div className="w-2/4 p-4 border-l border-t border-[#344e41]">
          ...
          <div className="flex min-h-40">
            <div className="w-12 whitespace-nowrap	border-t border-[#344e41] flex justify-center items-center p-4">
              <span className="rotate-[270deg] inline-block text-[#344e41] text-lg font-bold">
                Not Important
              </span>
            </div>
            <div className="w-2/4 p-4 border-l border-t border-[#344e41]">
        ...
        {/* <div className="w-4/12 border p-1">
          <span className="block text-xl text-[#344e41] font-semibold ml-2 mt-3">
            Challenges
          </span>
